...
│   └── page.tsx                 # Halaman Utama (Merakit Hero, TechStack, Denah 3D, Struktur, Galeri, Footer)
├── public/
...
│   └── data/
│       └── mockData.ts          # Pusat data: 57 foto galeri, 8 pengurus kelas, 35 data denah siswa
├── LICENSE                      # Lisensi resmi kepemilikan XII PPLG 1
├── package.json                 # Next.js 16, React 19, Three.js, Tailwind v4
